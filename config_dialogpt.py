...
class Args():
    def __init__(self):
        ...
        self.data_cache_dir = './cached/data/DialoGPT/add_context_add_strategy'
        ...
        # self.data_cache_dir = './cached/data/DialoGPT/add_contextCOMET'
        ...
        # self.data_cache_dir = './cached/data/DialoGPT/add_contextCOMET_relConstraint'
        ...
        # TAG = 'ablation_post'
        # nowtime = '10251756'
        self.output_dir = os.path.join('checkpoints', 'DialoGPT', TAG)
        self.generation_dir = os.path.join('outputs', 'DialoGPT_generated', TAG)
        ...
        self.model_cache_dir = './cached/models/DialoGPT/debug'
        # self.model_cache_dir = './cached/models/DialoGPT/large'

        # self.data_cache_dir = './cached/data/DialoGPT/debug_0.2'
        self.block_size = 512
        self.do_train = True
        self.do_eval = False
